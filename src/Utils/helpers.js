...
exports.createSendToken = (user, res) => {
    ...
    console.log(process.env.JWT_COOKIE_EXPIRES_IN, process.env.JWT_EXPIRY);
...
exports.isValidPhoneCountryCode = (countryCode) => {
  return validPhoneCountryCodes.includes(countryCode);
